...
- Name: dialogs.spec.ts >> Member Management - Dialog E2E >> renders member page with table and opens Create Member dialog
- Location: e2e/dialogs.spec.ts:252:7
...
Locator: getByText('Member Management')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Member Management')
